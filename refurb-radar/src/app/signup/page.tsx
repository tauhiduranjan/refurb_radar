// signup/page.tsx
// This page provides a sign up form for new users to create a Refurb Radar account.
    ...
    <main style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '1.7rem', fontWeight: 700, marginBottom: '1.2rem', color: 'var(--color-5)', fontFamily: 'var(--font-fredoka), cursive' }}>
          Create your Refurb Radar account
        </h1>
        {/* Sign up form */}
        <form>
          <input
        ...
        <div style={{ margin: '1.2rem 0', color: 'var(--color-4)' }}>or sign up with</div>
        ...
        <div style={{ marginTop: '1.5rem', color: 'var(--color-4)', fontSize: '0.98rem' }}>
          Already have an account? <a href="/signin" style={{ color: 'var(--color-5)', textDecoration: 'underline' }}>Sign in</a>
        </div>
      </div>
    </main>
  );
